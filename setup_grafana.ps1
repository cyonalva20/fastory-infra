...
$infraDashboard = @'
{
  "dashboard": {
    "id": null,
    "uid": "ffs9xy5157bpce",
    "title": "Fastory - Infrastructure Overview",
    ...
    "panels": [
      ...
      },
      {
        ...
        "datasource": {"type": "prometheus", "uid": "PBFA97CFB590B2093"},
        "targets": [
          {"expr": "go_gc_duration_seconds{quantile=\"1\"}", "legendFormat": "{{job}} GC max"}
        ],
        "fieldConfig": {
          "defaults": {
            "unit": "s",
      ...
      },
      {
        ...
        "datasource": {"type": "prometheus", "uid": "PBFA97CFB590B2093"},
        "targets": [
          {"expr": "rate(prometheus_tsdb_head_samples_appended_total[5m])", "legendFormat": "samples/sec"}
        ],
        "fieldConfig": {
          "defaults": {
            "unit": "ops",
            "color": {"mode": "fixed", "fixedColor": "super-light-green"},
            "custom": {"fillOpacity": 30, "lineWidth": 2, "gradientMode": "scheme"}
          }
        }
      }
    ],
...
Write-Host "Updating Infrastructure Dashboard with REAL metrics..."
try {
...
Write-Host "DONE! Dashboard updated with real Prometheus data."
