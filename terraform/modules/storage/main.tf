...
resource "aws_s3_bucket" "frontend" {
  ...
  # checkov:skip=CKV_AWS_145: "Cifrado KMS bloquea acceso publico anonimo a sitios estaticos S3."
...
# ════════════════════════════════════════════════
# Cifrado automático de todos los objetos con AWS KMS (alias/aws/s3).
